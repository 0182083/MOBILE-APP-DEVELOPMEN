...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var btnLogin: Button // declare a variable
    lateinit var progressBar: ProgressBar //initially declare a variable for association
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            if (user == "Farhan" && pass == "mashuk1234") {
